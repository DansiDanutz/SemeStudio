    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-sm text-[#52525B]">
          Log in to your SemeStudio account
        </p>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <a href="#" className="text-xs text-[#A1A1AA] hover:text-[#FAFAFA] transition-colors">
              Forgot password?
            </a>
          </div>
          <Input
      ...
      <p className="mt-6 text-center text-sm text-[#52525B]">
        ...
        <Link href="/signup" className="text-[#FF0000] hover:text-[#CC0000] font-medium transition-colors">
          Sign up free
        </Link>
      </p>
    </div>
