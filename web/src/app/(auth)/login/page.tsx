  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-sm text-[#52525B]">Log in to your SemeStudio account</p>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-[#52525B]">
        ...
        <Link href="/signup" className="text-[#FF0000] hover:text-[#CC0000] font-medium transition-colors">Sign up free</Link>
      </p>
    </div>
  );
}
